...
public class MyFriendsAdapter extends RecyclerView.Adapter<MyFriendsAdapter.ProductViewHolder> {
    ...
    private List<MyFriendsItem> productList;

    //getting the context and product list with constructor
    public MyFriendsAdapter(Context mCtx, List<MyFriendsItem> productList) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.myfriends_item, null);
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        MyFriendsItem product = productList.get(position);
